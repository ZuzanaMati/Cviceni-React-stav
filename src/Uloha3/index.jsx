...
export const Uloha3 = () => {
	const [cisloNaKostce, setCislo] = useState(1) /* jedna až šest */
	...
	return (
		<div className="kostka">
			...
			<button onClick={() => { setCislo(cisloNaKostce + 1), cisloNaKostce === 6 && setCislo(1) }} className="kostka__akce">další moje</button>
			<button onClick={() => { setCislo((cisloNaKostce % 6) + 1) }} className="kostka__akce">další</button>
		</div>
	)
}
